...
# * 0xF015 = fa-house
# * 0xF09C = fa-unlock
# * 0xF0D7 = fa-caret-down
# * 0xF0D8 = fa-caret-up
# * 0xF05B = fa-crosshairs
# * 0xE4BE = fa-arrows-to-dot
RANGE_FA_REGULAR="0xF11C"
RANGE_FA_SOLID="0xF3BE,0xF053,0xF054,0xF55A,0xF00C,0xF00D,0xF071,0xF068,0xF067,0xF013,0xF002,0xF204,0xE4AF,0xF1EB,0xF2C7,0xE13C,0xF015,0xF09C,0xF0D7,0xF0D8,0xF05B,0xE4BE"
...
# * 0xF013 = fa-gear
ICONS_SIZES=(36)
RANGE_ICONS_FA_SOLID="0xF06D,0xF2DC,0xF06E,0xE55B,0xF0B2,0xE4AF,0xF013"
