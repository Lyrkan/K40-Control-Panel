...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 8984, .adv_w = 192, .box_w = 36, .box_h = 9, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 9146, .adv_w = 120, .box_w = 27, .box_h = 8, .ofs_x = -1, .ofs_y = 1},
    {.bitmap_index = 9254, .adv_w = 192, .box_w = 39, .box_h = 13, .ofs_x = -1, .ofs_y = -2},
    {.bitmap_index = 9508, .adv_w = 216, .box_w = 45, .box_h = 13, .ofs_x = -1, .ofs_y = -2},
    {.bitmap_index = 9801, .adv_w = 120, .box_w = 24, .box_h = 11, .ofs_x = -1, .ofs_y = -1},
    {.bitmap_index = 9933, .adv_w = 120, .box_w = 21, .box_h = 11, .ofs_x = 1, .ofs_y = -1},
    {.bitmap_index = 10049, .adv_w = 168, .box_w = 36, .box_h = 10, .ofs_x = -1, .ofs_y = 0},
    {.bitmap_index = 10229, .adv_w = 168, .box_w = 36, .box_h = 2, .ofs_x = -1, .ofs_y = 4},
    {.bitmap_index = 10265, .adv_w = 192, .box_w = 42, .box_h = 11, .ofs_x = -1, .ofs_y = -1},
    {.bitmap_index = 10496, .adv_w = 168, .box_w = 36, .box_h = 13, .ofs_x = -1, .ofs_y = -2},
    {.bitmap_index = 10730, .adv_w = 216, .box_w = 45, .box_h = 9, .ofs_x = -1, .ofs_y = 0},
    {.bitmap_index = 10933, .adv_w = 240, .box_w = 51, .box_h = 11, .ofs_x = -1, .ofs_y = -1},
    {.bitmap_index = 11214, .adv_w = 216, .box_w = 45, .box_h = 9, .ofs_x = -1, .ofs_y = 0},
    {.bitmap_index = 11417, .adv_w = 120, .box_w = 27, .box_h = 13, .ofs_x = -1, .ofs_y = -2},
    {.bitmap_index = 11593, .adv_w = 144, .box_w = 30, .box_h = 13, .ofs_x = -1, .ofs_y = -2},
    {.bitmap_index = 11788, .adv_w = 216, .box_w = 45, .box_h = 9, .ofs_x = -1, .ofs_y = 0}
};
