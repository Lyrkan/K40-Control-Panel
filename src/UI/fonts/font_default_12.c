 ...
 * Size: 12 px
 * Bpp: 4
 * Opts: --lcd --no-compress --bpp 4 --size 12 --font ./fonts/Roboto-Regular.ttf -r 0x20-0x7F,0xB0,0x2022 --font ./fonts/fa-regular-400.ttf -r 0xF11C --font ./fonts/fa-solid-900.ttf -r 0xF3BE,0xF053,0xF054,0xF55A,0xF00C,0xF00D,0xF071,0xF068,0xF067 --format lvgl --no-kern --lv-include lvgl.h -o ../src/UI/fonts/font_default_12.c
 ******************************************************************************/
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 8145, .adv_w = 192, .box_w = 36, .box_h = 9, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 8307, .adv_w = 120, .box_w = 27, .box_h = 8, .ofs_x = -1, .ofs_y = 1},
    {.bitmap_index = 8415, .adv_w = 120, .box_w = 24, .box_h = 11, .ofs_x = -1, .ofs_y = -1},
    {.bitmap_index = 8547, .adv_w = 120, .box_w = 21, .box_h = 11, .ofs_x = 1, .ofs_y = -1},
    {.bitmap_index = 8663, .adv_w = 168, .box_w = 36, .box_h = 10, .ofs_x = -1, .ofs_y = 0},
    {.bitmap_index = 8843, .adv_w = 168, .box_w = 36, .box_h = 2, .ofs_x = -1, .ofs_y = 4},
    {.bitmap_index = 8879, .adv_w = 192, .box_w = 42, .box_h = 11, .ofs_x = -1, .ofs_y = -1},
    {.bitmap_index = 9110, .adv_w = 216, .box_w = 45, .box_h = 9, .ofs_x = -1, .ofs_y = 0},
    {.bitmap_index = 9313, .adv_w = 144, .box_w = 30, .box_h = 13, .ofs_x = -1, .ofs_y = -2},
    {.bitmap_index = 9508, .adv_w = 216, .box_w = 45, .box_h = 9, .ofs_x = -1, .ofs_y = 0}
};
