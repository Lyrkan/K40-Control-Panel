...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 9508, .adv_w = 120, .box_w = 24, .box_h = 11, .ofs_x = -1, .ofs_y = -1},
    {.bitmap_index = 9640, .adv_w = 120, .box_w = 21, .box_h = 11, .ofs_x = 1, .ofs_y = -1},
    {.bitmap_index = 9756, .adv_w = 168, .box_w = 36, .box_h = 10, .ofs_x = -1, .ofs_y = 0},
    {.bitmap_index = 9936, .adv_w = 168, .box_w = 36, .box_h = 2, .ofs_x = -1, .ofs_y = 4},
    {.bitmap_index = 9972, .adv_w = 192, .box_w = 42, .box_h = 11, .ofs_x = -1, .ofs_y = -1},
    {.bitmap_index = 10203, .adv_w = 216, .box_w = 45, .box_h = 9, .ofs_x = -1, .ofs_y = 0},
    {.bitmap_index = 10406, .adv_w = 240, .box_w = 51, .box_h = 11, .ofs_x = -1, .ofs_y = -1},
    {.bitmap_index = 10687, .adv_w = 216, .box_w = 45, .box_h = 9, .ofs_x = -1, .ofs_y = 0},
    {.bitmap_index = 10890, .adv_w = 120, .box_w = 27, .box_h = 13, .ofs_x = -1, .ofs_y = -2},
    {.bitmap_index = 11066, .adv_w = 144, .box_w = 30, .box_h = 13, .ofs_x = -1, .ofs_y = -2},
    {.bitmap_index = 11261, .adv_w = 216, .box_w = 45, .box_h = 9, .ofs_x = -1, .ofs_y = 0}
};
